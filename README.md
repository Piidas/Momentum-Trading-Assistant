...
This section contains all necessary steps you need to get MTA up and running:
  ...
  2) Make sure not to use IB API as it is available via `pip` as this package is outdated and no longer supported. It needs to be downloaded and installed manually, see https://interactivebrokers.github.io/#. Follow the instruction on the website for installation.
